  ...
  return (
    <div className="sideBar sticky-top">
      <div className="sideBarWrapper">
        ...
        <a className="btn btn-primary btn-block shadow btn-tweet">
          <span className="d-flex d-lg-none align-items-center justify-content-center">
            <EditIcon />
          </span>
          <span class="d-none d-lg-flex align-items-center justify-content-center">
            Tweet
          </span>
        </a>
      </div>
